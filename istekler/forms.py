...
class IstekForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'tibbi_malzeme_ilac_asi': forms.TextInput(
                attrs={
                    'class': 'form-control',
                    'placeholder': 'Tıbbi malzeme / İlaç / Aşı',
                }
            ),
            'kisisel_gereksinimler': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Kişisel Gereksinimler'}
            ),
            'hastane_adi': forms.Select(attrs={'class': 'form-select', 'placeholder': 'Hastane'}),
            'hastanenin_altyapi_gereksinimleri_sorunlari': forms.TextInput(
                attrs={
                    'class': 'form-control',
                    'placeholder': 'Hastanenin Altyapı Gereksinimleri / Sorunları',
                }
            ),
            'hastanede_saglik_calisani_gereksinimi': forms.TextInput(
                attrs={
                    'class': 'form-control',
                    'placeholder': 'Hastanede Sağlık Çalışanı Gereksinimi',
                }
            ),
            'temel_gereksinimler': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Temel Gereksinimler'}
            ),
            'ailevi_gereksinimler': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Ailevi Gereksinimler'}
            ),
            'diger_gereksinimler': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Diğer Gereksinimler'}
            ),
